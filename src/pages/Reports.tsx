            ...
            <Tabs defaultValue="sales" onValueChange={setActiveTab} value={activeTab}>
              ...
              <TabsContent value="sales">
                ...
                <div className="mt-4 bg-gray-50 p-4 rounded-md">
                  ...
                  <p>Total Sales for Period: <strong>£{salesData.reduce((sum, item) => sum + item.total, 0).toFixed(2)}</strong></p>
                  <p>Total Transactions: <strong>{salesData.reduce((sum, item) => sum + item.transactions, 0)}</strong></p>
                </div>
              </TabsContent>
              ...
              <TabsContent value="payment">
                ...
                <div className="mt-4 bg-gray-50 p-4 rounded-md">
                  ...
                  <p>Total Amount: <strong>£{paymentMethodsData.reduce((sum, method) => sum + method.amount, 0).toFixed(2)}</strong></p>
